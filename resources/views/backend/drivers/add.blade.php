    ...
    <div class="row">
      <div class="col-lg-12">
        ...
        <div class="kt-portlet">
          ...
          <!--begin::Form-->
          <form class="kt-form kt-form--label-right" id="frmAdd" action="{{ ADMIN_URL }}drivers/add">
            <div class="kt-portlet__body">
              ...
              <div class="form-group row">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                  <input type="text" class="form-control required" name="v_dispatch_name" placeholder="Dispatch Name">                  
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                  <div class="input-group">
                    <input type="text" class="form-control required phone" name="v_phone" placeholder="Phone">                    
                  </div>                  
                </div>
              </div>
              ...
              <div class="form-group row">
                  ...
                  <div class="col-md-4 col-lg-4 col-sm-12">
                    <input type="text" class="form-control required" name="v_extension" placeholder="Extension">    
              ...
              <div class="form-group row">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            ...
                            <div style="margin-top:20px">
                                ...
                                <button class="btn btn-default" style="display: {{  File::exists(DRIVER_PROFILE_IMG_PATH.$records) && $records !='' ? 'none' : 'inline-block' }};" type="button" id="file_trriger"><?php echo File::exists(DRIVER_PROFILE_IMG_PATH . $records) && $records != '' ? 'Change' : 'Select Image'; ?></button>
                                <span class="cropper_area_elements" style="display:none;">
                                    <button class="btn btn-default" type="button" id="remove_image" style="display: {{  File::exists(DRIVER_PROFILE_IMG_PATH.$records) && $records !='' ? 'inline-block' : 'none' }};">Remove</button>
