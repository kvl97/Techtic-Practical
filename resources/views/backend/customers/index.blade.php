    ...
    <div class="kt-portlet kt-portlet--mobile">
                ...
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">
                        <div class="kt-portlet__head-actions">
                            <a href="{{ ADMIN_URL }}customers/add" class="btn btn-brand btn-elevate btn-icon-sm">
      ...
      <div class="kt-portlet__body">
        <div class="table-bulk-action kt-hide">
          ...
          <input type="hidden"  class="table-group-action-url" value="<?php echo ADMIN_URL.'customers/bulk-action';?>"/>
        </div>
        ...
        <table class="table table-striped- table-bordered table-hover table-checkable" id="datatable_ajax">
            ...
            <thead>
                <tr class="filter">
                    ...
                    <td><input type="text" class="form-control form-control-sm form-filter kt-input" name="e_gender"></td>
                    <td><input type="text" class="form-control form-control-sm form-filter kt-input date_picker" name="d_dob"></td>
...
@section('custom_js')
  <script>
    $(document).ready(function() {
      ...
      var url = ADMIN_URL + 'customers/list-ajax';
