...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        .myTablePrint, .myTablePrint td, .myTablePrint th {
            border: 1px solid black !important;
        }
        .myTablePrint td, .myTablePrint th {
    ...
    <body>
        <div class="col-md-12 col-lg-12 table-responsive mb-3">
            <table class="table table-bordered myTablePrint" id="myTable" style="min-width: 760px;">
                ...
                @else                               
                    ...
                    <?php $data = json_decode($value['v_manifest_json'], true);  ?>
                        ...
                        <tr>
                            <td rowspan="11" class="align-middle" style="background: darkseagreen;text-align: center;"><strong>{{$value['id']}}</strong></td>
                            ...
                            <td style="width:15%">{{ $data['pu_time_'.($value['id']).''] ? $data['pu_time_'.($value['id']).''] : ''}}</td>
                        ...
                        <tr>
                            ...
                            <td style="width:15%">{{ $data['pu_milege_'.($value['id']).''] ? $data['pu_milege_'.($value['id']).''] : ''}}</td>
                        ...
                        <tr>
                            ...
                            <td style="width:15%">{{ $data['do_time_'.($value['id']).''] ? $data['do_time_'.($value['id']).''] : ''}}</td>
                        ...
                        <tr>
                            ...
                            <td style="width:18%">{{ $data['actual_time_'.($value['id']).''] ? $data['actual_time_'.($value['id']).''] : ''}}</td>
                            <td style="width:15%;background: #dcdcf3;"><strong>D/O Mileage</strong></td>
                            <td style="width:15%">{{ $data['do_mileage_'.($value['id']).''] ? $data['do_mileage_'.($value['id']).''] : ''}}</td>
                        ...
                        <tr>
                            ...
                            <td style="width:18%">{{ $data['contact_text_'.($value['id']).''] ? $data['contact_text_'.($value['id']).''] : ''}}</td>
                        ...
                        <tr>
                            ...
                            <td>{{ $data['cross_st_'.($value['id']).''] ? $data['cross_st_'.($value['id']).''] : ''}}</td>
                            <td></td>
                        </tr>
