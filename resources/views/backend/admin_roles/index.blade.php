    ...
    <div class="kt-portlet kt-portlet--mobile">
            ...
            <div class="kt-portlet__head-label">
                ...
                <div class="kt-portlet__head-wrapper">
                    <div class="kt-portlet__head-actions">
                        <a href="{{ ADMIN_URL }}admin-roles/add" class="btn btn-brand btn-elevate btn-icon-sm">
      ...
      <div class="kt-portlet__body">
        ...
        <div class="table-bulk-action kt-hide">
          ...
          <input type="hidden"  class="table-group-action-url" value="<?php echo ADMIN_URL.'admin-roles/bulk-action';?>"/>
        </div>
...
@section('custom_js')
  <script>
    $(document).ready(function() {
      ...
      var url = ADMIN_URL + 'admin-roles/list-ajax';
