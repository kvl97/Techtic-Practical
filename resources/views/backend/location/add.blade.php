    ...
    <div class="row">
      <div class="col-lg-12">
        ...
        <div class="kt-portlet">
          ...
          <!--begin::Form-->
          <form class="kt-form kt-form--label-right" id="frmAdd" action="{{ ADMIN_URL }}location/add">
            <div class="kt-portlet__body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                    <input type="text" class="form-control required" name="v_label" placeholder="Label" maxlength="100">                    
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                    <textarea class="form-control required" name="v_street1" placeholder="Street" maxlength="100"></textarea>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                      <label class="kt-mt-10 v_county" id="v_county"></label>               
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                      <label class="kt-mt-10 i_service_area_id" id="i_service_area_id"></label>             
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                    <input type="text" class="form-control" name="v_postal_code" placeholder="Postal Code" maxlength="20">                  
                    </div>
                </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 radio-btn-msg">
                        <div class="kt-radio-inline mt-10">
                          ...
                          <label class="kt-radio">
                            <input type="radio" class="required-least-one-radio" name="e_service_type" value="Shared" id="shared" groupid="service_type" checked='checked'> Shared
                          </label>
