    ...
    <div class="row">
      <div class="col-lg-12">
        ...
        <div class="kt-portlet">
          ...
          <!--begin::Form-->
          <form class="kt-form kt-form--label-right" id="frmAdd" action="{{ ADMIN_URL }}system-name-def/add">
            <div class="kt-portlet__body">
              ...
              <div class="form-group row">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                  <input type="text" class="form-control required" name="v_label" placeholder="Label">                  
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                  <input type="text" class="form-control required" name="v_label_desc" placeholder="Description">                  
                </div>
              </div>
