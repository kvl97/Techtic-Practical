    ...
    <div class="kt-portlet kt-portlet--mobile">
        <div class="kt-portlet__head kt-portlet__head--lg">
            <div class="kt-portlet__head-label">
                ...
                @if(isset($permission) && isset($permission[12]['i_add_edit']) && $permission[12]['i_add_edit'] == 1)
                    <div class="kt-portlet__head-toolbar">
                        <div class="kt-portlet__head-wrapper">
                            <div class="kt-portlet__head-actions">
                                <a href="{{ ADMIN_URL }}system-name-def/add" class="btn btn-brand btn-elevate btn-icon-sm">
      ...
      <div class="kt-portlet__body">
        <div class="table-bulk-action kt-hide">
          ...
          <select class="form-control form-control-sm form-filter kt-input table-group-action-input" title="Select Action" name="bulk_action" style="width: 150px;display: inline;">
            ...
            <option value="Inactive">Suffix</option>
            @if(isset($permission) && isset($permission[12]['i_delete']) && $permission[12]['i_delete'] == 1)
          ...
          <input type="hidden"  class="table-group-action-url" value="<?php echo ADMIN_URL.'system-name-def/bulk-action';?>"/>
        </div>
        <!--begin: Datatable -->
        <table class="table table-striped- table-bordered table-hover table-checkable" id="datatable_ajax">
            ...
            <thead>
                <tr class="filter">
                    ...
                    <td><input type="text" class="form-control form-control-sm form-filter kt-input" name="v_label"></td>
                    <td><input type="text" class="form-control form-control-sm form-filter kt-input" name="v_label_desc"></td>
...
@section('custom_js')
  <script>
    $(document).ready(function() {
      ...
      var url = ADMIN_URL + 'system-name-def/list-ajax';
