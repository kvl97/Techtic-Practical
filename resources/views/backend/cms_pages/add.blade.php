    ...
    <div class="row">
      <div class="col-lg-12">
        ...
        <div class="kt-portlet">
          ...
          <!--begin::Form-->
        <form class="kt-form kt-form--label-right" id="frmAdd" action="{{ ADMIN_URL }}blog/add">
            <div class="kt-portlet__body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12">
                        <textarea type="text" class="form-control required summernote-1" name="t_content" placeholder="Content" cols="8" id="summernote"></textarea>                 
                    </div>
                </div>
