        ...
        <div class="kt-portlet__head kt-portlet__head--lg">
            <div class="kt-portlet__head-label">
                <span class="kt-portlet__head-icon">
                    <i class="kt-font-brand fas fa-address-book"></i>
                </span>
      ...
      <div class="kt-portlet__body">
        @if(isset($permission) && $permission[11]['i_delete'] == 1)
            ...
            <select class="form-control form-control-sm form-filter kt-input table-group-action-input" title="Select Action" name="bulk_action" style="width: 150px;display: inline;">
                ...
                @if(isset($permission) && isset($permission[16]['i_delete']) && $permission[16]['i_delete'] == 1)
            ...
            <input type="hidden"  class="table-group-action-url" value="<?php echo ADMIN_URL.'contact-enquiry/bulk-action';?>"/>
            </div>
        @endif
        ...
        <table class="table table-striped- table-bordered table-hover table-checkable" id="datatable_ajax">
            <thead>
                <tr>
                    @if(isset($permission) && $permission[16]['i_delete'] == 1)
            ...
            <thead>
                <tr class="filter">
                    ...
                    <td><input type="text" class="form-control form-control-sm form-filter kt-input" name="t_message"></td>
                    <td>
...
@section('custom_js')
  <script>
    $(document).ready(function() {
      ...
      @endif
      var url = ADMIN_URL + 'contact-enquiry/list-ajax';
