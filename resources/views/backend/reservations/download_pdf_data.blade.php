...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <table style="background-color: #FFF;margin: 0 -10px 0 0;">
            <tr>
                <td style="padding:0;">
                    <table style="page-break-inside: avoid;background-color: #dcdcf3; border-radius: 10px 10px 0 0;">
                        <tr>
                    ...
                    <table style="background-color:#fff;margin: 20px 0px 0px 0px;page-break-inside: avoid;">
                            <tr>
                                <td>
                                        ...
                                        <tr>
                                            <td align="left" style="background-color: #FFF; border: 1px solid #ccc;width: 48%;vertical-align: top;">
                                                <table>
                                                    ...
                                                    <tr>
                                                        <td style="padding:20px 0px 12px 20px;">
                                                            Name
                                                        </td>
                                            ...
                                            <td align="right" style="background-color: #fff; width: 48%">
                                                <table>
                                                    ...
                                                    <tr style="height:10px;" height="10px"></tr>
                                                    <tr style="border: 1px solid #ccc;border-radius: 10px;">
                    ...
                    <table style="background-color:#fff;margin: 20px 0px 0px 0px;">
                            <tr>
                                <td style="padding:0px 0px 0px 0px;">
                                    <table style="border: 1px solid #ccc; background-color:#fff; margin:0 0 20px 0;page-break-inside: avoid;">
                                        <tr style="background-color:#f0f0f9;">
                                            <td style="padding:1rem 20px;">
                                                            ...
                                                            <td style="width:48%;vertical-align: top;">
                                                                <table style="background-color:#f0f0f9;">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td style="vertical-align:top;width: 20px;text-align: center;">:</td>
                                                                        <td style="padding:0px 20px 12px 0px;vertical-align: top;"><span> {{ $reservation_record['v_dropoff_address']  ? $reservation_record['v_dropoff_address'] :  '-'}}</span></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td style="padding:0px 0px 12px 20px;vertical-align: top;">
                                                                            <strong>City</strong>
                                                                        ...
                                                                        <td style="vertical-align:top;width: 20px;text-align: center;">:</td>
                                                                        <td style="padding:0px 20px 12px 0px;vertical-align: top;"><span>{{$reservation_record['DropOffCity']['v_city'] ? $reservation_record['DropOffCity']['v_city'] : '-' }}</span></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td style="padding:0px 0px 20px 20px;vertical-align: top;">
                                                                            <strong>County</strong>
                                                                        ...
                                                                        <td style="vertical-align:top;width: 20px;text-align: center;">:</td>
                                                                        <td style="padding:0px 20px 20px 0px;vertical-align: top;"><span>{{$reservation_record['DropOffCity']['v_county'] ? $reservation_record['DropOffCity']['v_county'] : '-' }}</span></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                        </tr>
                                        ...
                                        @else
                                        <tr>
                                            <td colspan="2" style="padding:1rem 1rem 20px 20px;text-align: center">
                                    ...
                                    <table style="border: 1px solid #ccc; background-color:#fff; margin:0 0 20px 0;page-break-inside: avoid;">
                                        <tr style="background-color:#f0f0f9;">
                                            <td style="padding:1rem 20px;"><strong class="d-none d-sm-none d-md-none d-lg-inline">2ND LEG OF TRAVEL: </strong><span>{{ $reservation_record_rt['v_reservation_number'] }}</span></td>
                                                            ...
                                                            <td style="width:48%;vertical-align: top;">
                                                                <table style="background-color:#f0f0f9;">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td style="vertical-align:top;width: 20px;text-align: center;">:</td>
                                                                        <td style="padding:0px 20px 12px 0px;vertical-align: top;"><span> {{ $reservation_record_rt['v_pickup_address']  ? $reservation_record_rt['v_pickup_address'] :  '-'}}</span></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td style="padding:0px 0px 12px 20px;vertical-align: top;">
                                                                            <strong>City</strong>
                                                                        ...
                                                                        <td style="vertical-align:top;width: 20px;text-align: center;">:</td>
                                                                        <td style="padding:0px 20px 12px 0px;vertical-align: top;"><span>{{$reservation_record_rt['PickupCity']['v_city'] ? $reservation_record_rt['PickupCity']['v_city'] : '-' }}</span></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td style="padding:0px 0px 20px 20px;vertical-align: top;">
                                                                            <strong>County</strong>
                                                                        ...
                                                                        <td style="vertical-align:top;width: 20px;text-align: center;">:</td>
                                                                        <td style="padding:0px 20px 20px 0px;vertical-align: top;"><span>{{$reservation_record_rt['PickupCity']['v_county'] ? $reservation_record_rt['PickupCity']['v_county'] : '-' }}</td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                            <td style="width:2%;background-color:#FFF;"></td>
                                                            <td style="width:48%;vertical-align: top;">
                                                                <table style="background-color:#f0f0f9;">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td style="vertical-align:top;width: 20px;text-align: center;">:</td>
                                                                        <td style="padding:0px 20px 12px 0px;vertical-align: top;"><span> {{ $reservation_record_rt['v_dropoff_address']  ? $reservation_record_rt['v_dropoff_address'] :  '-'}}</span></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td style="padding:0px 0px 12px 20px;vertical-align: top;">
                                                                            <strong>City</strong>
                                                                        ...
                                                                        <td style="vertical-align:top;width: 20px;text-align: center;">:</td>
                                                                        <td style="padding:0px 20px 12px 0px;vertical-align: top;"><span>{{$reservation_record_rt['DropOffCity']['v_city'] ? $reservation_record_rt['DropOffCity']['v_city'] : '-' }}</span></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td style="padding:0px 0px 20px 20px;vertical-align: top;">
                                                                            <strong>County</strong>
                                                                        ...
                                                                        <td style="vertical-align:top;width: 20px;text-align: center;">:</td>
                                                                        <td style="padding:0px 20px 20px 0px;vertical-align: top;"><span>{{$reservation_record_rt['DropOffCity']['v_county'] ? $reservation_record_rt['DropOffCity']['v_county'] : '-' }}</td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                    ...
                                    @if(!empty($total_fare_amount['adult_count'] || $total_fare_amount['child_count'] || $total_fare_amount['infant_count'] || $total_fare_amount['military_count'] || $total_fare_amount['senior_count']))
                                        <table style="border: 1px solid #ccc; background-color:#fff; padding:10px 0 0 0;page-break-inside: avoid;">
                                            <thead>
                                    ...
                                    @if((count($reservation_luggage_info) > 0) || (count($reservation_pet_info) > 0))
                                        @if($reservation_record['e_shuttle_type']=='Shared')
                                        <table style="border: 1px solid #ccc; background-color:#fff;  margin:20px 0 20px 0;page-break-inside: avoid;">
                                            <thead>
                                                <tr style="border-bottom: 1px solid #ccc;">
                                        ...
                                        <table style="border: 1px solid #ccc; background-color:#fff;  margin:20px 0 20px 0;page-break-inside: avoid;">
                                            <thead>
                                                <tr style="border-bottom: 1px solid #ccc;">
                                                    <th style="text-align: left;background-color: #f0f0f9;border: 1px solid #ccc;text-transform: uppercase;padding: 10px;">1ST LEG OF LUGGAGE DETAILS</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                @foreach($reservation_luggage_info as $records)
                                    ...
                                    @if(isset($reservation_luggage_info_rt))
                                        ...
                                        <table style="border: 1px solid #ccc; background-color:#fff;  margin:20px 0 20px 0;page-break-inside: avoid;">
                                            <thead>
                                                <tr style="border-bottom: 1px solid #ccc;">
                                                    <th style="text-align:left;background-color: #f0f0f9;border: 1px solid #ccc;text-transform: uppercase;padding: 10px;">2ND LEG OF LUGGAGE DETAILS</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                @foreach($reservation_luggage_info_rt as $records_rt)
                                    ...
                                    @if($reservation_record['e_shuttle_type']=='Shared')                
                                    <table style="page-break-inside: avoid;margin: 15px 0px;">
                                        <tr>
