    ...
    <div class="row">
      <div class="col-lg-12">
        ...
        <div class="kt-portlet">
          ...
          <!--begin::Form-->
          <form class="kt-form kt-form--label-right" id="frmAdd" action="{{ ADMIN_URL }}admin-groups/add">
            <div class="kt-portlet__body">
              ...
              <div class="form-group row">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                  <input type="text" class="form-control required" name="v_desc" placeholder="Description">                  
                </div>
              </div>
              ...
              <div class="kt-form__actions">
                <div class="row">
                  <div class="col-lg-9 ml-lg-auto">
                    ...
                    <a href="{{ ADMIN_URL }}admin-groups" class="btn btn-secondary"> Cancel </a>
