    ...
    <section class="rocket-info">
        <div class="container">
            <div class="row no-gutters justify-content-center">
                <div class="col-md-9">
                    <div class="rocket-info-right-pp">
                        <div class="tab-content" id="v-tabContent">
                            ...
                            <div class="tab-pane fade show active" id="payment" role="tabpanel" aria-labelledby="payment-tab">
                                <form id="frontend_payment" method="POST" action="{{SITE_URL}}payment/{{ $reservation_record->id }}" class="rocket-info-details rocket-info-payment custom-form">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <h3 class="rocket-info__title pb-10">Payment</h3>
                                        </div>
                                    <div class="rocket-info__six py-5">
                                        <div class="payment-block opt-pay-by-card">
                                            ...
                                            <div class="payment-block-form row">
                                                ...
                                                <div class="payment-expiry-month form-group">
                                                    <div class="select-field">
                                                        <select err-msg="Expiry Month" class="pay-select-fields form-control form-input required" id="i_card_exp_month">
                                            ...
                                            <div class="row justify-content-end">
                                                        ...
                                                        <div class="row no-gutters align-items-center">
                                                            ...
                                                            <div class="col-lg-4 col-md-8 mb-2 mb-md-0">
                                                                <div class="input-field">
                                                                    <input type="text" name="v_discount_code" id="v_discount_code" class="form-control" placeholder="" />
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="col-lg-5 col-12 text-right mt-3 mt-lg-0">
                                                    <div class="price-box">
                                                        ...
                                                        <p class="mb-2"><span>Subtotal </span> <span><strong class="show_sub_total">{{ '$'.number_format($total_payment,2) }}</strong></span></p>
                                                        
                                                        <p class="mb-2 d-none"><span>Discount </span> <span><strong class="show_discount"></strong></span></p>
                                                        <p class="total-prices">
                                                            <span>Total Fare </span><span class="show_total_total">{{ '$'.number_format($total_payment,2) }}</span>
                                                        </p>
                                        ...
                                        <div class="rocket-info__two--text pt-10">
                                            <div class="row no-gutters">
                                                <input type="hidden" name="stripe_card_id" />
                                                <input type="hidden" name="i_card_exp_month" />
                                                <input type="hidden" name="i_card_exp_year" />
                                                @if($reservation_record->added_by_id != '' && $reservation_record->added_by_type_id == 1 && auth()->guard('admin')->check() && !auth()->guard('customers')->check())
...
<script>
    ...
    $(document).ready(function() {
        ...
        var total_amount = "{{ $total_payment - $discountPrice }}";
        var discount = 0;
