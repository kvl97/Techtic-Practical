                            ...
                            <tr>
                                <td style="padding:0px 0px 0px 0px;">
                                    ...
                                    <table style="border: 1px solid #ccc; background-color:#fff; margin:0 0 20px 0;page-break-inside: avoid;">
                                        <tr style="background-color:#f0f0f9;">
                                            <td style="padding:1rem 20px;">
                                                <strong>2ND LEG OF TRAVEL: </strong>{{ $reservation_record_rt['v_reservation_number'] }}
                                            </td>
                                        ...
                                        @if(isset($reservation_record_rt['PickupCity']) && (!empty($reservation_record_rt['PickupCity']) && !empty($reservation_record_rt['DropOffCity'] )))
